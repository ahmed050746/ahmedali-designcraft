      ...
      <div className={`${pageWrap} py-10`}>
        <div className="flex flex-col justify-between gap-8 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="mt-1 font-mono text-[10px] uppercase tracking-[0.16em] text-paper/55">
              UI/UX Engineer · Product Designer — Karachi, Pakistan
            </p>
          </div>
          <nav className="flex flex-wrap gap-x-6 gap-y-3 font-mono text-[10px] uppercase tracking-[0.14em] text-paper/65">
        ...
        <p className="mt-8 font-mono text-[10px] text-paper/45">
...
export function ContactBlock({
  ...
  return (
    <section className="bg-ink text-paper">
      <div className={`${pageWrap} grid gap-12 py-20 lg:grid-cols-12 lg:py-28`}>
        <div className={includeForm ? "lg:col-span-7" : "lg:col-span-9"}>
          <p className="eyebrow text-amber">{index ? `${index} / Contact` : "Contact"}</p>
          <h2 className="mt-5 max-w-[18ch] font-serif text-4xl leading-tight sm:text-5xl">
            Have a product that needs a better interface?
          </h2>
          <p className="mt-5 max-w-[52ch] text-sm leading-6 text-paper/70">
            Whether you&apos;re designing a new product, improving an existing interface, or
            building a scalable design system, I&apos;d be happy to discuss the project.
          </p>
          <dl className="mt-9 grid gap-5 border-t border-paper/15 pt-6 font-mono text-[10px] uppercase sm:grid-cols-3">
            <div>
              <dt className="text-paper/45">Email</dt>
              <dd className="mt-1">[ADD EMAIL]</dd>
            </div>
            <div>
              <dt className="text-paper/45">LinkedIn</dt>
              <dd className="mt-1">[ADD LINKEDIN]</dd>
            </div>
            <div>
              <dt className="text-paper/45">Location</dt>
              <dd className="mt-1">Karachi, Pakistan</dd>
            </div>
          </dl>
        </div>
        {includeForm && (
          <form onSubmit={submit} className="rounded-lg border border-paper/15 p-6 lg:col-span-5">
            ...
            <label className="form-label mt-5">Project / Message</label>
            <Textarea
              required
            ...
            {sent && (
              <p role="status" className="mt-4 flex gap-2 text-xs text-paper/70">
                <Check className="size-4 text-amber" />
                Thanks — the form is ready to connect once Ahmed&apos;s email is added.
              </p>
            )}
          </form>
        )}
