...
function HomePage() { return <>
  <section className="bg-paper pt-16 text-ink"><div className={`${pageWrap} grid gap-10 py-16 sm:py-20 lg:grid-cols-12 lg:items-center lg:py-24`}><div className="lg:col-span-7"><p className="eyebrow text-amber">UI/UX Engineer · Product Designer</p><h1 className="mt-5 max-w-[17ch] font-serif text-[2.65rem] leading-[1.02] sm:text-5xl lg:text-6xl">Designing digital products that make complex things feel <em className="not-italic text-amber">simple</em>.</h1><p className="mt-5 max-w-[56ch] text-[15px] leading-7 text-ink-soft">I&apos;m Ahmed Ali, a UI/UX Engineer and Product Designer focused on SaaS platforms, LMS products, dashboards, responsive interfaces, and design systems. I combine product thinking, visual design, and front-end understanding to create practical digital experiences.</p><div className="mt-7 flex flex-wrap items-center gap-3"><Button asChild size="lg"><Link to="/work">View My Work</Link></Button><Button asChild variant="outline" size="lg"><Link to="/contact">Let&apos;s Work Together</Link></Button><Availability/></div></div><div className="lg:col-span-5"><HeroVisual/><p className="mt-3 font-mono text-[9px] uppercase text-ink-soft">Fig. 01 — Product interface fragment</p></div></div></section>
